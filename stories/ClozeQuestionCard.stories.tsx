...
import ClozeQuestionCard from "@/components/shared/quiz/cloze-question-card";
...
const meta: Meta<typeof ClozeQuestionCard> = {
  ...
  parameters: {
    ...
    docs: {
      ...
      description: {
        component:
          "Fill in the Blank / Cloze question. Stateless, hanya interaksi input/select.",
      },
    },
...
export const ClickToUndo: Story = {
  ...
  args: {
    ...
    segments: [
      ...
      {
        kind: "blank",
        blank: { id: "b1", options: ["are", "is"], placeholder: "_____" },
      },
      { kind: "text", text: " " },
      {
        kind: "blank",
