...
import { MatchQuestionCard } from "@/components/shared/quiz/match-question-card";
...
const meta: Meta<typeof MatchQuestionCard> = {
  ...
  parameters: {
    ...
    docs: {
      ...
      description: {
        component:
          "Matching pairs question with mixed-media prompt (Duolingo-style).",
      },
    },
  ...
  args: {
    question: {
      ...
      rightItems: [
        {
          id: "r-terima-kasih",
          content: { kind: "text", text: "Terima kasih" },
        },
  ...
  argTypes: {
    question: {
      description: "Match question data: prompt, leftItems, rightItems",
    },
    matches: { description: "Current matched pairs (controlled)" },
    onCreateMatch: {
      action: "match",
      description: "Create a match (leftId, rightId)",
    },
...
function ControlledMatch(args: React.ComponentProps<typeof MatchQuestionCard>) {
  ...
  return (
    <MatchQuestionCard
      ...
      matches={pairs}
      onCreateMatch={(l, r) =>
        setPairs((p) => [...p, { leftId: l, rightId: r }])
      }
    />
  );
}
  ...
  args: {
    question: {
      ...
      rightItems: [
        {
          id: "r-cat",
          content: { kind: "text", text: "Cat" },
          clickSoundUrl: "https://www.w3schools.com/html/horse.mp3",
        },
        {
          id: "r-dog",
          content: { kind: "text", text: "Dog" },
          clickSoundUrl: "https://www.w3schools.com/html/horse.mp3",
        },
      ],
    },
