    ...
    >
      <div className="relative w-full aspect-video">
        ...
        <div className="absolute bottom-2 left-2 right-2 flex items-center gap-2">
          <span className="px-2 py-1 rounded-full text-xs font-semibold bg-black/60 text-white">
            {formatDuration(video.durationSec)}
          </span>
          <span className="px-2 py-1 rounded-full text-xs font-semibold bg-emerald-500 text-white">
            +{video.xpReward} XP
          </span>
          <span className="ml-auto px-2 py-1 rounded-full text-xs font-semibold bg-white/80 text-neutral-900 capitalize">
            {video.difficulty}
          </span>
        </div>
      </div>
