        ...
        <main>
          <section className="relative bg-emerald-500 rounded-2xl p-6 md:p-8">
            <div className="grid grid-cols-1 md:grid-cols-3 items-center">
              <div className="md:col-span-2">
                <h1
                  className={`${nunito.variable} font-[800] text-white text-3xl md:text-4xl`}
                >
                  Learn with Videos
                </h1>
                <p className="text-white/90 mt-2">
                  Watch short clips, learn vocabulary, and train your listening.
                </p>
              </div>
              <div className="flex justify-center md:justify-end">
                <Image
                  src="https://picsum.photos/seed/clapper/120/120"
                  alt="Clapper"
                  width={120}
                  height={120}
            ...
            <div className="absolute top-4 right-4 flex items-center gap-2">
              <span className="px-3 py-1 rounded-full bg-white text-emerald-700 text-xs font-bold">
                🔥 3-day listening streak
              </span>
              <span className="px-3 py-1 rounded-full bg-white text-emerald-700 text-xs font-bold">
                ⭐ 42 Video XP
              </span>
          ...
          <section className="mt-6">
            <div className="flex items-center justify-between mb-2">
              <h2
                className={`${nunito.variable} font-[800] text-slate-800 text-xl`}
              >
                Chapter Progress
              </h2>
            </div>
          ...
          {hasHistory && (
            <section className="mt-8">
              <h2
                className={`${nunito.variable} font-[800] text-slate-800 text-xl mb-2`}
              >
                Continue Watching
              </h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {continueWatching.map((v) => (
                  <div
                    key={v.id}
                    className="bg-white rounded-2xl shadow border-[3px] border-slate-300 p-3"
                  >
                    ...
                    <div className="mt-2 h-2 bg-slate-200 rounded-full overflow-hidden">
                      <div
                        ...
                        style={{
                          width: `${Math.min(100, Math.max(0, v.progressPercent))}%`,
                        }}
                      />
                    </div>
